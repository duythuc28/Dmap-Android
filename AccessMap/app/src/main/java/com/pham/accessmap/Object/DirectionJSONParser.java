...
public class DirectionJSONParser {
    ...
    public List<DirectionParser> parsed(JSONObject jObject){

        List<DirectionParser> routes = new ArrayList<>() ;
        JSONArray jRoutes = null;
        JSONArray jLegs = null;
        JSONArray jSteps = null;
        ...
        try {
            ...
            for(int i=0;i<jRoutes.length();i++){
                jLegs = ( (JSONObject)jRoutes.get(i)).getJSONArray("legs");
                DirectionParser tDirectionParser = new DirectionParser();
                tDirectionParser.mListLocations  = new ArrayList<HashMap<String, String>>();
